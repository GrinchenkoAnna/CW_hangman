...
$(DIR_OBJ)game_process.o: $(DIR_SRC)game_process.c 
	gcc $(DIR_SRC)game_process.c -c -Wall -Werror -o $(DIR_OBJ)game_process.o
...
test: $(DIR_OBJ)sketch.o $(DIR_TEST_OBJ)sketch_test.o $(DIR_TEST_OBJ)hidden_word.o $(DIR_TEST_OBJ)hidden_word_test.o $(DIR_OBJ)input_control.o $(DIR_TEST_OBJ)input_control_test.o $(DIR_TEST_OBJ)game_process.o $(DIR_TEST_OBJ)game_process_test.o $(DIR_TEST_OBJ)main.o
	gcc $(DIR_OBJ)sketch.o $(DIR_TEST_OBJ)sketch_test.o $(DIR_TEST_OBJ)hidden_word.o $(DIR_TEST_OBJ)hidden_word_test.o $(DIR_OBJ)input_control.o $(DIR_TEST_OBJ)input_control_test.o $(DIR_TEST_OBJ)game_process.o $(DIR_TEST_OBJ)game_process_test.o $(DIR_TEST_OBJ)main.o -Wall -Werror -o unit_tests
