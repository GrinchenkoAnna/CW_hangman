...
clean:
	rm -rf $(TARGET) test_game_process $(DIR_OBJ)*.o $(DIR_TEST_OBJ)*.o
...
test: $(DIR_TEST_OBJ)game_process_test.o $(DIR_TEST_OBJ)game_process.o $(DIR_OBJ)input_control.o $(DIR_OBJ)sketch.o $(DIR_TEST_OBJ)main.o
	gcc $(DIR_TEST_OBJ)game_process_test.o $(DIR_TEST_OBJ)game_process.o $(DIR_OBJ)input_control.o $(DIR_OBJ)sketch.o $(DIR_TEST_OBJ)main.o -Wall -Werror -o test_game_process
